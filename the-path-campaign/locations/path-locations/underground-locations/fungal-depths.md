...
***Giant Mushroom Forest - Passive:*** Massive fungi tower overhead, creating a surreal underground canopy. The mushrooms emit faint bioluminescence, providing dim light throughout the cavern. PCs can harvest fungal materials with an Instinct roll. On a success, gather edible or alchemically useful specimens. On a success with Fear, disturb aggressive spore clouds with unpredictable effects.
...
***Unpredictable Spore Cloud - Action:*** Disturbing certain mushroom clusters releases thick clouds of spores with varying effects. All creatures in Close range are affected. Roll a d6: On 1-2, creatures take 1d6+1 poison damage; On 3-4, creatures mark 2 Stress from disorientation and nausea; On 5-6, creatures lose 1 Hope as despair-inducing spores cloud their judgment.
  ...
  *What different types of fungi produce these varied spore effects? How do the spores interact with each creature differently? Can experienced spelunkers predict which mushrooms produce which effects?*

## FEATURE QUESTIONS

- What surface ecosystem feeds nutrients to these deep fungal chambers?
- How does the bone-scattering predator fit into the underground food web?
- What valuable resources could be sustainably harvested from this fungal ecosystem?
- How do the tree roots maintain their connection between surface and depths?