...
***Tier 1 Traversal***
*A cluster of ancient stone formations where watchtowers and signal fires once formed a defensive line against creatures emerging from the mist.*
...
***Rocky Outcrop Fortification - Passive:*** The weathered stone formations create natural defensive positions with clear sightlines. PCs fighting from behind the fortified outcrops gain +1 to Evasion. Any PC can use an action to take full cover behind the massive stones, gaining +2 to Evasion against ranged attacks instead until they move or take an offensive action. The ancient builders designed these highlands to turn landscape into advantage.
...
***Signal Fire Ward - Action:*** PCs can ignite the ancient highland braziers using 1 Flame Essence. The moment the sacred fires roar to life, all mist creatures within Close range immediately mark 3 hit points from the searing protective flames. Mist creatures at Very Far range or closer become Vulnerable as the blazing light reveals their incorporeal forms. The signal fires burn bright enough to be seen across the mist - the GM can spend 3 Fear to have powerful mist creatures (GM's choice) arrive at the highland position, drawn by the challenge to the mist's dominion. The flames burn until the end of the current scene.
  ...
  *What visions appear in the signal flames when they ignite? How do mist creatures react when they see these ancient defenses reawakened? What distant powers in the mist take notice of the blazing challenge?*

***Cairn Bindings - Passive:*** Each time PCs build a cairn at this highland position, mark progress on a counter (start at 0). When the counter reaches 10, the accumulated stone markers create a powerful navigational anchor and Highland Watch gains the **Stable** modifier. If the counter drops below 10 for any reason, the location reverts to **Unstable**. The cairns hold ancient power to anchor locations against the shifting mist.

  *What ancient power flows through these carefully stacked stones? How do the cairns communicate with each other across the mist? What happens when travelers disturb or add to the sacred stone arrangements?*

## FEATURE QUESTIONS

- What ancient disaster first brought the mist and its creatures to threaten this highland region?
- How effective were these defensive positions against the supernatural mist incursions?
- What knowledge about fighting mist creatures was preserved in the watchtower records?
- Could these highland defenses be restored to protect against current mist threats?